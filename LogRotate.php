...
class LogRotate
{
     ...
     * @return bool
     */
    public static function process(string $file, int $size=30): bool
    {
     ...
     * @return bool
     */
    protected static function checkProcessFileSize(string $file, int $size=30): bool
    {
        clearstatcache();
     ...
     * ]
     */
    protected static function getFileInfo(string $file): array
    {
